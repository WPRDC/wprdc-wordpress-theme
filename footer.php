...
<div class="footer-container" data-sticky-footer>
    <footer class="footer">
        ...
        <div class="medium-3 columns">
            <img class="footer-logo" src="<?php echo get_template_directory_uri() ?>/assets/images/plain_logo_rbg_cropped.svg">\
            <ul class="quick-links">
                <li><a class="yellow" href="about">About</a></li>
                <li><a class="yellow" href="about">Contact Us</a></li>
                <li><a class="yellow" href="about">Terms</a></li>
                <li><a class="yellow" href="about">Privacy</a></li>
            </ul>

        </div>
        <div class="medium-9  columns quicklinks">
            <!--                    <ul>-->
